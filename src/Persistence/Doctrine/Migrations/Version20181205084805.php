 ...
 */
final class Version20181205084805 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE selected_products CHANGE receipt_id receipt_id INT NOT NULL, CHANGE product_id product_id INT NOT NULL, CHANGE cost cost INT(12) NOT NULL COMMENT \'(DC2Type:money_type)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE selected_products CHANGE receipt_id receipt_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE cost cost INT(12) NOT NULL COMMENT \'(DC2Type:money_type)\'');
    }
}
